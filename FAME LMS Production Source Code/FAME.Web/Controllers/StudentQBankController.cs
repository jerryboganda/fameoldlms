...
{
    public class StudentBankController : ApiController
    {
        ...
        public IHttpActionResult GetQuestionToSolve(int id)
        {
            ...
            System.Diagnostics.Trace.TraceInformation($"StudentBankController.GetQuestionToSolve: id={id}, dataNull={data == null}, detailsCount={data?.Details?.Count}");
