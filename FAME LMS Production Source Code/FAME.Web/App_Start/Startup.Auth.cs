...
namespace First_Aid_Made_Easy
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            var googleClientId = WebConfigurationManager.AppSettings["GoogleOAuthClientId"];
            var googleClientSecret = WebConfigurationManager.AppSettings["GoogleOAuthClientSecret"];
            if (!string.IsNullOrWhiteSpace(googleClientId) && !string.IsNullOrWhiteSpace(googleClientSecret))
            {
                var googleOptions = new GoogleOAuth2AuthenticationOptions
                {
                    ...
                    CallbackPath = new PathString(WebConfigurationManager.AppSettings["GoogleOAuthCallbackPath"] ?? "/signin-google")
                };
