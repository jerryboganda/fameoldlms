...
var KTSlidersWidget1 = function () {
	...
	return {
		init: function () {
			l(e, "#kt_slider_widget_1_chart_1", $("#kt_slider_widget_1_chart_1").data('per'));
			var r = document.querySelector("#kt_sliders_widget_1_slider");
			r && (r.addEventListener("slid.bs.carousel", (function (e) {
				1 === e.to && l(t, "#kt_slider_widget_1_chart_2", $("#kt_slider_widget_1_chart_2").data('per')), 2 === e.to && l(a, "#kt_slider_widget_1_chart_3", $("#kt_slider_widget_1_chart_3").data('per'))
			})), KTThemeMode.on("kt.thememode.change", (function () {
				e.rendered && (e.self.destroy(), e.rendered = !1), t.rendered && (t.self.destroy(), t.rendered = !1), a.rendered && (a.self.destroy(), a.rendered = !1), l(e, "#kt_slider_widget_1_chart_1", $("#kt_slider_widget_1_chart_1").data('per')), l(t, "#kt_slider_widget_1_chart_2", $("#kt_slider_widget_1_chart_2").data('per')), l(a, "#kt_slider_widget_1_chart_3", $("#kt_slider_widget_1_chart_3").data('per'))
			})))
		}
	}
}();
